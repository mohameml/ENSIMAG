/**
 * \file test_Dvector_operators.cpp
 * \brief Test File for Dvector operators
 * \author Arnaud Ibakuyumcu Benjamin Lebit
 * \version 2.0 (Scalar multiplication added)
 * \date 23 February 2016
 *
 * \details Permit to test the class Dvector (and so Darray).
 */
...
int main(int argc, char* argv[]) {
    ...
    if (argc == 1) {
       ...
       cout << "\n\n 4) Equal operator = : ";
        Dvector dv4;
        dv4 = dv1;
        assert(dv4.getArray() != dv1.getArray());
        ...
        // SCALE OPERATOR //
        cout << "\n\n 8) Scale operator : \n";
        cout << "\n\t 8.1) With different length of vector : ";
        dv4(0) = 2;
        dv4(1) = 1;
        dv4(2) = 3;
        Dvector dv6(dv4);
        ...
        dv2 = dv1;
        d2 = d1;
        assert(dv1.getArray() != dv2.getArray());
        assert(dv1(0) == dv2(0));
        if (dv2 != dv1){
        ...
        cout << "\n\n !!!!! Too much argument, usage : ./test_Dvector_operators [argument 1] [argument 2]";
    }
